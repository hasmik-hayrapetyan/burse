    ...
    $.fn.timepicki = function (options) {
        ...
        return this.each(function () {
            ...
            var top_arrow_button = (settings.increase_direction === 'down') ?
                "<div class='prev action-prev'><i class='fa fa-angle-up'></i></div>" :
                "<div class='prev action-next'><i class='fa fa-angle-down'></i></div>";
            var bottom_arrow_button = (settings.increase_direction === 'down') ?
                "<div class='next action-next'><i class='fa fa-angle-down'></i></div>" :
                "<div class='next action-prev'><i class='fa fa-angle-up'></i></div>";
